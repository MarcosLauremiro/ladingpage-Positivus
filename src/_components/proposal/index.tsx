...
export function Proposal() {
  return (
    <section className="container mx-auto text-center px-4 py-20">
      <div className="flex flex-col gap-4 bg-[#F3F3F3] rounded-2xl p-8 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="hidden lg:block relative w-1/2 h-[300px]">
